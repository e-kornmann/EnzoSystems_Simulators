...
import { ReactComponent as ExpandIcon } from '../local_assets/expand.svg';
// enums
...
// components
import { ActiveTransaction } from './components/ActiveTransaction/ActiveTransaction';
import { SelectScheme } from './components/DeviceSettings/AvailableSettings/SelectScheme';
import { Message, MessageContainer } from './components/Message/Message';
import TimeRibbon from './components/TimeRibbon/TimeRibbon';
...
const PinTerminalComponent = () => {
  ...
  return (
      <S.SharedStyledContainer $isDraggable={import.meta.env.VITE_EXPORT_MEMO_APP}>
...
export const PinTerminal = memo(PinTerminalComponent);
