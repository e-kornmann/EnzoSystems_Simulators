      ...
      {selectedKey
        && <StyledKeyBox>
          ...
          <StyledBoxContent>
            ...
            <StyledDates>
              <StyledDate>{format(parseISO(selectedKey.data.startDateTime), 'yyyy-MM-dd | HH:mm')}</StyledDate>
              <StyledDate>{format(parseISO(selectedKey.data.endDateTime), 'yyyy-MM-dd | HH:mm')}</StyledDate>
            </StyledDates>
