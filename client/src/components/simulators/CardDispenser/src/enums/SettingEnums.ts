...
enum BINPOLICY {
  ALLUNTAKENCARDS = 'ALLUNTAKENCARDS',
  ONLYFAULSYCARDS = 'ONLYFAULSYCARDS',
}
...
export { STACKSTATUSES, BINSTATUSES, CARDPOSITIONS, DEVICESTATUSOPTIONS, FAILPROCESS, APPSETTINGS, Lang, BINPOLICY };
